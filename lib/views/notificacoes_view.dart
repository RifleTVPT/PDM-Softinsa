...
class _NotificacoesViewState extends State<NotificacoesView> {
  ...
  final List<NotificacaoModel> _notificacoes = [
    NotificacaoModel(
      idNotificacao: 1,
      tituloNotificacao: "Candidatura Aprovada!",
      mensagemNotificacao:
          "O seu pedido para o Badge LowCode Nível A foi validado com sucesso pelo Service Line Leader.",
      dataEnvioNotificacao: "Hoje, 14:32",
      tipoNotificacao: "aprovado",
      estadoLido: 0,
    ),
    NotificacaoModel(
      idNotificacao: 2,
      tituloNotificacao: "Alerta de SLA Ultrapassado",
      mensagemNotificacao:
          "A sua candidatura de DevOps excedeu o tempo limite estipulado para validação.",
      dataEnvioNotificacao: "Ontem, 09:15",
      tipoNotificacao: "expiracao",
      estadoLido: 0,
    ),
    NotificacaoModel(
      idNotificacao: 3,
      tituloNotificacao: "Correção de Evidências Necessária",
      mensagemNotificacao:
          "O ficheiro submetido para o requisito A2 não é legível. Por favor, faça o upload de um novo documento.",
      dataEnvioNotificacao: "14 Mai, 18:00",
      tipoNotificacao: "rejeitado",
      estadoLido: 1,
    ),
    NotificacaoModel(
      idNotificacao: 4,
      tituloNotificacao: "Novo Learning Path Disponível",
      mensagemNotificacao:
          "A Softinsa lançou novos desafios e badges na service line de Data & AI.",
      dataEnvioNotificacao: "10 Mai, 11:20",
  ...
  void _verDetalhesNotificacao(NotificacaoModel notif) {
    setState(() {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text("Recebido: ${notif.dataEnvioNotificacao}",
